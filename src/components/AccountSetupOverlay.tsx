        ...
        <div className="mt-5 flex flex-col gap-3">
          <label className="flex flex-col gap-1">
            ...
            <input
              ...
              autoFocus
              className="h-11 rounded-lg border border-softgrey px-3 text-[14px] outline-none focus-visible:ring-2 focus-visible:ring-[#20B9FA] focus-visible:ring-offset-2"
            />
          </label>
          <label className="flex flex-col gap-1">
          ...
          {error && <p className="rounded-lg bg-[#fef2f2] px-3 py-2 text-[12.5px] text-[#b42318]">{error}</p>}
        </div>
