...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-full flex-col bg-offwhite">
      <PublicHeader />
      <main id="main-content" className="mx-auto flex w-full max-w-2xl flex-col items-center gap-6 px-6 py-20 text-center">
        ...
        <p className="max-w-md text-[15px] leading-relaxed text-charcoal/60">
          The page you were looking for doesn&rsquo;t exist. Here are some helpful places to go instead:
        </p>
