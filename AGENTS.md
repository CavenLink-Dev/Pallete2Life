...
- Entitlement model: first design is free to generate, edit, and preview; first export is $0.99 USD one-time; HueSet Pro is $14.99 USD/month. Payments are gated by `VITE_PAYMENTS_ENABLED` (default off); when disabled, purchase CTAs show Early Access / Notify Me instead of checkout.
